...
import { ArrowRight, Cpu, Globe, Users, Puzzle, Heart, Link2 } from "lucide-react"
    ...
    <div className="pt-24">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 mb-8">
              At HealthSigns, technology meets healthcare to create a seamless, innovative, and personalized patient
              management experience. We are a pioneering health-tech brand committed to revolutionizing the way patients
              in India, the Middle East, and the US receive medical care.
            </p>
          </MotionDiv>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <MotionDiv initial="hidden" animate="visible" variants={fadeInUp}>
              <div className="relative h-[400px] w-full rounded-3xl overflow-hidden shadow-xl">
                <Image src="/placeholder.svg?height=800&width=1200" alt="What We Do" fill className="object-cover" />
            ...
            <MotionDiv initial="hidden" animate="visible" variants={fadeInUp}>
              ...
              <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
                HealthSigns offers a suite of advanced healthcare solutions designed to enhance patient care and
                provider efficiency. Our core offering includes Remote Patient Management, enabling continuous
                monitoring and care beyond traditional clinical settings.
              </p>
              <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
                We are also developing a clinical decision support system that provides healthcare professionals with
                real-time, evidence-based insights. By seamlessly integrating with existing healthcare infrastructures,
                we ensure that patients receive timely, personalized care while supporting providers in making informed
                clinical decisions.
              </p>
              <p className="text-lg text-gray-700 dark:text-gray-300">
                Our platform is designed to evolve, continually incorporating the latest advancements in AI and
                healthcare technology to meet the dynamic needs of the industry.
              </p>
            </MotionDiv>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-br from-purple-50 to-white dark:from-gray-800 dark:to-gray-900 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold mb-6 gradient-text">How We Work</h2>
              <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
                Our unique business model allows us to partner with established healthcare providers in India, the
                Middle East, and the US. By leveraging our partners' existing customer bases, we seamlessly integrate
                our remote patient monitoring services, enhancing their capabilities and extending their reach.
              </p>
              <p className="text-lg text-gray-700 dark:text-gray-300">
                This collaborative approach ensures that patients receive consistent, high-quality care, regardless of
                their location.
              </p>
            </MotionDiv>
            <MotionDiv
            ...
            >
              <div className="relative h-[400px] w-full rounded-3xl overflow-hidden shadow-xl">
                <Image src="/placeholder.svg?height=800&width=1200" alt="How We Work" fill className="object-cover" />
                <div className="absolute inset-0 bg-gradient-to-br from-purple-500/20 to-transparent"></div>
              </div>
      ...
      <section className="py-20 bg-white dark:bg-gray-900">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6 gradient-text">Our Technology</h2>
            <p className="text-lg text-gray-700 dark:text-gray-300">
              HealthSigns utilizes advanced AI technology to continuously monitor patient data, identifying early signs
              of potential health issues. Our platform provides healthcare providers with actionable insights, enabling
              ...
              {[
                {
                  ...
                  description: "Our system collects vital health data from various devices and wearables in real-time.",
                },
                {
                  title: "AI Analysis",
                  description:
                ...
                },
                {
                  ...
                  description: "Healthcare providers receive clear, actionable insights to make informed decisions.",
                },
                {
                  title: "Personalized Care",
                  description: "Patients receive personalized care plans based on their unique health data.",
                },
              ].map((item, index) => (
                <MotionDiv
                  key={index}
                  variants={fadeInUp}
                  className={`flex items-start mb-12 ${index % 2 === 0 ? "justify-start md:pr-24" : "justify-end md:pl-24"}`}
                >
                  <div
                    className={`relative bg-gradient-to-br from-purple-50 to-white dark:from-gray-800 dark:to-gray-900 p-6 rounded-2xl shadow-lg max-w-md glass ${index % 2 === 0 ? "md:ml-12" : "md:mr-12"}`}
                  >
                    <div
      ...
      <section className="py-20 bg-gradient-to-br from-purple-50 to-white dark:from-gray-800 dark:to-gray-900 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <MotionDiv
            ...
            className="text-center max-w-3xl mx-auto mb-16"
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6 gradient-text">Why Choose HealthSigns?</h2>
          </MotionDiv>
              ...
              >
                <Card className="h-full border-none shadow-lg hover:shadow-xl transition-shadow duration-300 bg-white dark:bg-gray-900 rounded-2xl card-3d">
                  <CardContent className="p-6">
                    <div className="mb-4 bg-purple-100 dark:bg-purple-900/30 p-3 rounded-full w-fit">{item.icon}</div>
                    <h3 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white">{item.title}</h3>
                    <p className="text-gray-700 dark:text-gray-300">{item.description}</p>
                  </CardContent>
                </Card>
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl mb-8">
              At HealthSigns, we believe in the power of technology to transform healthcare. Join us on our mission to
              provide better care for patients around the world.
            </p>
            <Button size="lg" className="bg-white text-purple-600 hover:bg-gray-100 rounded-full">
